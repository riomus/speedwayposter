...
import { Kh118Poster } from "../components/posters/Kh118Poster";
...
import { kh118Config } from "../components/posters/configs/kh118Config";

export default function Kh118Page() {
  ...
  const {
    ...
    moveCustomText,
    setConfig,
  } = usePosterConfig(kh118Config.defaultConfig);
  ...
  return (
    ...
    >
        ...
        >
          <div
            style={{
              width: 6,
              height: 32,
              background: "linear-gradient(to bottom, #DC2626, #1D4ED8)",
              borderRadius: 3,
            }}
          />
          <div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
            ...
            {(["preview", "config"] as const).map((tab) => (
              <button
                ...
                style={{
                  ...
                  textTransform: "uppercase",
                  fontFamily: "'Barlow Condensed', sans-serif",
                  background: activeTab === tab ? "rgba(29,78,216,0.8)" : "transparent",
          ...
          <button
            ...
            style={{
              ...
              textTransform: "uppercase",
              fontFamily: "'Barlow Condensed', sans-serif",
              background: exporting ? "rgba(29,78,216,0.4)" : "linear-gradient(135deg, #1D4ED8, #DC2626)",
              color: "#fff",
        ...
        >
          ...
          >
            <div
              style={{
                boxShadow:
                  "0 0 0 1px rgba(29,78,216,0.2), 0 0 60px rgba(29,78,216,0.15), 0 24px 80px rgba(0,0,0,0.8)",
                borderRadius: 4,
                overflow: "hidden",
              }}
            >
              <Kh118Poster ref={posterRef} config={config} scale={1} isExporting={false} onCustomTextMove={moveCustomText} />
            </div>
      ...
      >
        <Kh118Poster ref={exportRef} config={config} scale={4} isExporting={true} />
      </div>
    </div>
  );
}

...
>(({ config, scale = 1, isExporting = false }, ref) => {
  ...
  const riderImg =
    BG_IMAGES[backgroundImageId || "1"] || riderImg1;
  const riderImgPos =
    BG_POSITIONS[backgroundImageId || "1"] || "center center";
    ...
    >
      ...
      <div
        style={{
          ...
          height: fs(4),
          background:
            "linear-gradient(to right, #1e6db5, #2e8de0, #f5c518)",
        }}
      />
      ...
      >
        ...
        <div
          style={{
            ...
            height: fs(44),
            background:
              "linear-gradient(to bottom, transparent, #1e6db5, transparent)",
            flexShrink: 0,
          }}
        />
      ...
      >
        ...
        {layoutId === "match_day" && (
          ...
          >
            {hasHome && (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: fs(8), flex: 1 }}>
      ...
      <div
        style={{
          ...
          height: fs(3),
          background:
            "linear-gradient(to right, #f5c518, #1e6db5, #2e8de0, #1e6db5, #f5c518)",
        }}
      />
    </div>
  );
...
SpeedwayPoster.displayName = "SpeedwayPoster";